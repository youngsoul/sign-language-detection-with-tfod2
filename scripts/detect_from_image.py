"""
Credit: https://github.com/TannerGilbert/Tensorflow-Object-Detection-with-Tensorflow-2.0/blob/master/detect_from_image.py
...
if __name__ == '__main__':
    ...
    model_path = f"{mc.EXPORTED_MODEL_PATH}/saved_model"
    labelmap = f"{mc.TF_ANNOTATION_PATH}/label_map.pbtxt"
